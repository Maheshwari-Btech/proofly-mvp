...
export const CareerTrialView: React.FC<CareerTrialViewProps> = ({
  ...
  const handleEvaluateAndSubmit = async () => {
    ...
    if (!codeSnippet.trim() || codeSnippet.trim().length < 50) {
      setSubmissionError('Add at least 50 characters of your own implementation code before submitting.');
      return;
    }
    if (!notes.trim() || notes.trim().length < 10) {
      setSubmissionError('Add a short explanation of your implementation decisions before submitting.');
      return;
    }
