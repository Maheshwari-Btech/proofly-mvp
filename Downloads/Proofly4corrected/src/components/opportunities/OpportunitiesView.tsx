...
import { Opportunity, OpportunityRequirement, RequirementImportance } from '../../types';
              ...
              <div>
                ...
                <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xl font-bold text-purple-700">{opp.readinessScore}%</p>
                  </div>
