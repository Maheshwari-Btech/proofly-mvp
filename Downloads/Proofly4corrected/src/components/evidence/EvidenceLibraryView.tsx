...
export const EvidenceLibraryView: React.FC<EvidenceLibraryViewProps> = ({
  ...
  const handleSaveEvidence = (e: React.FormEvent) => {
    ...
    const newItem: EvidenceItem = {
      ...
      title,
      type,
      description: description || `Verified ${type} demonstrating relevant technical proficiencies.`,
      issuer: issuer || 'Self-Directed Verification',
      date: date || new Date().toLocaleDateString('en-US', { month: 'short', year: 'numeric' }),
      externalUrl: externalUrl || undefined,
      skills: skills.length > 0 ? skills : ['Web Development', 'TypeScript'],
