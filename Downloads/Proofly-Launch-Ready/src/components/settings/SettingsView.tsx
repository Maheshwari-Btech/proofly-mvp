        ...
        <div className="md:col-span-8 bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-xs">
          {activeTab === 'privacy' && (
            <div className="space-y-6">
              ...
              <div className="p-4 bg-purple-50/70 border border-purple-100 rounded-xl text-xs text-purple-900 leading-relaxed">
                <strong>Row Level Security (RLS) Promise:</strong> Your uploaded documents, test scores, and private notes are protected by Supabase Row Level Security and scoped to your authenticated account.
              </div>
            </div>
          )}
          ...
          {activeTab === 'security' && (
            <div className="space-y-6">
              ...
              {securityMessage && (
                <div className="mb-3 p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-700" role="status">
                  {securityMessage}
                </div>
              )}
                ...
                <div className="pt-2 border-t border-slate-200 flex items-center justify-between">
                  ...
                  <button
                    onClick={async () => {
                      ...
                      const result = await supabaseAuth.resetPasswordForEmail(profile.email);
                      setSecurityMessage(
                        result.success
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="inline-flex items-center gap-1 text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 px-2.5 py-1 rounded-full">
                      ...
                      {serverHealth?.status === 'ok' ? 'Online' : 'Offline / fallback'}
                    </span>
                  </div>
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                  ...
                  <div className="mt-3 pt-3 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                    <div>
                      ...
                      <span className="font-semibold text-slate-800">5 Applied</span>
                    </div>
                    <div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-rose-50/60 rounded-xl border border-rose-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <p className="text-xs font-bold text-rose-900">Reset Workspace</p>
                    <p className="text-xs text-rose-700 mt-0.5">
                      Restores the local sample workspace (guest mode only).
                    </p>
                  </div>
                  <button
                    onClick={() => {
                      if (confirm('Reset this workspace? Your profile will be kept, but opportunities, evidence, assessments, trials, and progress will be removed.')) {
                        onResetData();
                      }
                    }}
